...
{
    /// <inheritdoc />
    public partial class InitilMigatn : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessClassSeats = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FirstClass = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
